insert into patient(patient_Id, name, gender, age, height, contact)
values (001, 'Noah Harith bin Hazman', 'Male', 35, 170, '017-2467989');

insert into patient(patient_Id, name, gender, age, height, contact)
values (002, 'Lee Xiu Ying', 'Female', 40, 155, '019-3897544');

insert into patient(patient_Id, name, gender, age, height, contact)
values (003, 'Arjun A/L Vikram', 'Male', 23, 180, '013-6833878');
